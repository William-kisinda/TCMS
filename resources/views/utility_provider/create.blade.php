...
@section('content')
      <div class="flex flex-col items-center justify-center px-6 py-5 mx-auto md:h-screen lg:py-0">
        <a
          href="#"
          class="flex items-center mb-6 text-2xl font-semibold dark:text-gray-900 text-white"
        >
          TCMS
        </a>
          ...
          <div class="p-6 space-y-4 md:space-y-2 sm:p-8">
            ...
            <form class="space-y-4 md:space-y-4" action="#">
              ...
              <p class="text-sm font-light text-gray-500 dark:text-gray-400">
                    Have an account already? <a href="{{route('login')}}" class="font-medium text-primary-600 hover:underline dark:text-primary-500">Login</a>
                </p> 
            </form>
          </div>
        </div>
